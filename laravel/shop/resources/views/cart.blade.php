                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <div style="position: relative;">
                            ...
                            <div style="position: absolute; left: 100px; right: 0; top: 0">
                                ...
                                <p class="bk_time" style="margin-top: 15px;">数量: <span class="bk_summary">x
                                        {{$cart_item->count}}</span></p>
                                <p class="bk_time">总计: <span class="bk_price">￥
                                        {{$cart_item->product->price * $cart_item->count}}</span></p>
                            </div>
                        </div>
                    </div>
                </label>
