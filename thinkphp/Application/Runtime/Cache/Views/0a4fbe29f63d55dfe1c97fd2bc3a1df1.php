        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                  ...
                  <div class="list-group">
                        <!-- for -->
                        <?php $__FOR_START_525298001__=0;$__FOR_END_525298001__=5;for($i=$__FOR_START_525298001__;$i < $__FOR_END_525298001__;$i+=1){ ?><a href="#" class="list-group-item">使用for标签循环了<?php echo ($i+1); ?>次了</a><?php } ?>
                  </div>
            </div>
            ...
            <div class="panel panel-default">
                  ...
                  <div class="list-group">
                        <?php $_FRIENDS_1502281037=get_user_friends(2);if(empty($_FRIENDS_1502281037)){echo $empty;}else{foreach ($_FRIENDS_1502281037 as $key => $jike_user) {?><a href="#" class="list-group-item"><?php echo ($jike_user['username']); ?></a><?php }} ?>
                  </div>
            </div>
